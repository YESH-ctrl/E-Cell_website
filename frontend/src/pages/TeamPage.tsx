...
const currentTeam = [
  ...
  { name: 'Shritha Reddy', role: 'Technical', dept: 'CS Engineering(AI/ML)', img: '/team/shritha_reddy.jpg', linkedin: 'https://linkedin.com', email: 'shritha@gmail.com' },
  { name: 'Sharan gaddam ', role: 'Social Media', dept: 'CS Engineering(Business Systems)', img: '/team/s_gaddam.jpg', position: 'object-[center_20%]', linkedin: 'https://linkedin.com', email: 'sharan@gmail.com' },
  { name: 'Hiranmayi Kasturi', role: 'Video Editing', dept: 'CS Engineering(Business Systems)', img: '/team/h_kasturi.jpg', position: 'object-[center_15%]', linkedin: 'https://linkedin.com', email: 'hiranmayi@gmail.com' },
  { name: 'Gnana Keerthana', role: 'GD', dept: 'Biomedical Engineering', img: '/team/gnana_keerthana.jpg', linkedin: 'https://linkedin.com', email: 'keerthana@gmail.com' },
  { name: 'Gowtham ', role: 'Treasury', dept: 'MBA', img: '/team/g_gowtham.jpg', position: 'object-[center_20%]', linkedin: 'https://linkedin.com', email: 'gowtham@gmail.com' },
  { name: 'Hemanth Reddy Solipeta', role: 'PR & Sponsorship', dept: 'CS Engineering', img: '/team/h_reddy_solipeta.jpg', linkedin: 'https://linkedin.com', email: 'hemanth@gmail.com' },
  { name: 'Sumedh', role: 'Hospitality', dept: 'Mechanical Engineering', img: '/team/sumedh.jpg', position: 'object-[center_20%]', linkedin: 'https://linkedin.com', email: 'sumedh@gmail.com' },
  { name: 'Pochigani Shyamsujith', role: 'Logistics', dept: 'MBA', img: '/team/pochigani_shyamsujith.jpg', linkedin: 'https://linkedin.com', email: 'shyamsujith@gmail.com' },
  { name: 'Patlolla Bhavya Sri ', role: 'Marketing', dept: 'CS Engineering(Business Systems)', img: '/team/p_bhavya_sri.jpg', linkedin: 'https://linkedin.com', email: 'bhavya@gmail.com' },
  { name: 'Nissi Priya P', role: 'Documentation', dept: 'CS Engineering(Business Systems)', img: '/team/n_priya_p.JPG', linkedin: 'https://linkedin.com', email: 'nissi@gmail.com' },
